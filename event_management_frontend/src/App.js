...
import nielogo from './NIE_logo.jpg';
import {
  ...
  return (
    <>
      ...
      <nav className="navbar navbar-expand-lg navbar-light" style={{ backgroundColor: "#FFB5BE" }}>
        <img src={nielogo} alt="NIE logo" style={{ height: "40px", width: "auto", marginRight: "10px", 
            paddingLeft: "10px" }} />
        <Link className="navbar-brand" to="/" style={{ color: "#333333", fontFamily: 'Poppins, sans-serif' }}>  NIE EventManager</Link>
        ...
        <div className="collapse navbar-collapse" id="navbarNav">
          <ul className="navbar-nav ms-auto">
            ...
            {!user ? (
              <>
                <li className="nav-item">
                  <Link className="nav-link" to="/register" style={{ color: "#333333", fontFamily: 'Poppins, sans-serif' }}>Sign In</Link>
                </li>
                <li className="nav-item">
